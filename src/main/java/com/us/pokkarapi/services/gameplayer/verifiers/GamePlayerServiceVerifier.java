 ...
 *
 */
public interface GamePlayerServiceVerifier {

	List<ErrorMessage> verifyCreateGamePlayer(CreateGamePlayerDto createGamePlayerDto);
	...
	List<ErrorMessage> verifyDeleteGamePlayer(DeleteGamePlayerDto deleteGamePlayerDto);
